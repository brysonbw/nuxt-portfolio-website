<script lang="ts">
   import discord from '$lib/images/Discord-Logo-Color.png'
</script>
...
viewBox="0 0 24 24"
aria-hidden="true"
class="w-5 h-5 transition fill-black group-hover:fill-zinc-600 dark:fill-white dark:group-hover:fill-zinc-300"
>
<path
fill-rule="evenodd"
clip-rule="evenodd"
